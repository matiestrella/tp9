...
${OBJECTDIR}/ej4.o: ej4.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ej4.o ej4.c
...
${OBJECTDIR}/ej4_nomain.o: ${OBJECTDIR}/ej4.o ej4.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/ej4.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ej4_nomain.o ej4.c;\
	else  \
	    ${CP} ${OBJECTDIR}/ej4.o ${OBJECTDIR}/ej4_nomain.o;\
	fi
